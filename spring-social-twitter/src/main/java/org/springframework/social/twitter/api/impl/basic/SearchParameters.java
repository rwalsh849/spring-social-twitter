...
public class SearchParameters  {
	 ...
	 *
	 * @param sinceId The minimum {@link org.springframework.social.twitter.api.impl.basic.Tweet} ID to return in the results
	 * @return The same SearchParameters for additional configuration.
	 */
	 ...
	 *
	 * @param maxId The maximum {@link org.springframework.social.twitter.api.impl.basic.Tweet} ID to return in the results
	 * @return The same SearchParameters for additional configuration.
	 */
