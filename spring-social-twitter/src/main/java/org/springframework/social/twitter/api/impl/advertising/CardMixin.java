...
/**
 * Mixin class for adding Jackson annotations to {@link Card}.
 * @author Richard Walsh
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public abstract class CardMixin extends TwitterObjectMixin {
	...
	CardMixin(
            ...
            @JsonProperty("googleplay_app_id") String googleplayAppId,
            @JsonProperty("ipad_app_id") String ipadAppId,
            @JsonProperty("iphone_app_id") String iphoneAppId,
            @JsonProperty("preview_url") String previewUrl,
            @JsonProperty("app_country_code") String appCountryCode) {}
}
