 ...
 */
public class StatisticalQueryingPromotedTweetDataBuilder extends StatisticalQueryingBaseDataBuilder {
	private List<String> promotedTweetIds;
	
	public StatisticalQueryingPromotedTweetDataBuilder withPromotedTweets(String... promotedAccountIds) {
	...
	protected void appendSpecificParameters(MultiValueMap<String, Object> params) {
		appendParameter(params, "promoted_tweet_ids", this.promotedTweetIds);
	}
